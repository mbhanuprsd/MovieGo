class TVDetails {
  ...
  TVDetails.fromJson(Map<String, dynamic> json) {
    ...
    lastEpisodeToAir =
        json['last_episode_to_air'] != null ? new LastEpisodeToAir.fromJson(json['last_episode_to_air']) : null;
    name = json['name'];
    nextEpisodeToAir =
        json['next_episode_to_air'] != null ? new NextEpisodeToAir.fromJson(json['next_episode_to_air']) : null;
...
class Seasons {
  ...
  Seasons({this.airDate, this.episodeCount, this.id, this.name, this.overview, this.posterPath, this.seasonNumber});
