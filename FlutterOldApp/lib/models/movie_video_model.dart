class MovieVideoModel {
  ...
  MovieVideoModel.fromJson(Map<String, dynamic> json) {
    ...
    if (json['results'] != null) {
      results = new List<MovieVideo>();
      json['results'].forEach((v) {
        results.add(new MovieVideo.fromJson(v));
      });
    }
  }
...
class MovieVideo {
  ...
  MovieVideo({this.id, this.iso6391, this.iso31661, this.key, this.name, this.site, this.size, this.type});
